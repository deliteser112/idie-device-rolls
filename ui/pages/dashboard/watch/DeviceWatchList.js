...
import { Chip, List, ListItem, Divider, ListItemText, ListItemAvatar, Avatar } from '@mui/material';
...
WatchTableToolbar.propTypes = {
  rollList: PropTypes.array,
  deviceList: PropTypes.array,
  numSelected: PropTypes.number.isRequired
};

export default function DeviceWatchList({ rollList, deviceList }) {
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2, padding: 3 }}>
        <WatchTableToolbar
          ...
          onChooseDevice={handleChooseDevices}
                ...
                .map((row, index) => {
                  ...
                  return [
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none" sx={{ fontWeight: '900' }}>
                        {row.device}
                      </TableCell>
                      <TableCell align="right" sx={{ color: 'primary.main' }}>{row.dice}</TableCell>
                      ...
                      <TableCell align="right">
                        ...
                        >
                          {row.elapsedTime < 1
                            ? 'Just now'
                            : row.elapsedTime >= 1 && row.elapsedTime < 5
